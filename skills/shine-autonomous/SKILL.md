...
<execution_context>
@~/.claude/shine/workflows/autonomous.md
...
Project context, phase list, and state are resolved inside the workflow using init commands (`shine-tools.cjs init milestone-op`, `shine-tools.cjs roadmap analyze`). No upfront context loading needed.
</context>

<process>
Execute the autonomous workflow from @~/.claude/shine/workflows/autonomous.md end-to-end.
