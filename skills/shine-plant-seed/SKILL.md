...
Consumed by: /shine-new-milestone (scans seeds and presents matches)
</objective>

<execution_context>
@~/.claude/shine/workflows/plant-seed.md
</execution_context>

<process>
Execute the plant-seed workflow from @~/.claude/shine/workflows/plant-seed.md end-to-end.
</process>
