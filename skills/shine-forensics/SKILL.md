---
name: shine-forensics
description: "Post-mortem investigation for failed SHINE workflows — analyzes git history, artifacts, and state to diagnose what went wrong"
...
<objective>
Investigate what went wrong during a SHINE workflow execution. Analyzes git history, `.planning/` artifacts, and file system state to detect anomalies and generate a structured diagnostic report.
...
<execution_context>
@~/.claude/shine/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @~/.claude/shine/workflows/forensics.md end-to-end.
</process>
